...
function Get-EntraPostureEndpointAllowlist {
    ...
    return @(
        ...
        [ordered]@{ Host = 'graph.microsoft.com'; PathTemplate = '/v1.0/groupSettings';                    ApiStability = 'Stable'; Method = 'GET'; ReadOnlyClassification = $null; Description = 'List tenant-wide group settings (COL-003)' }
        [ordered]@{ Host = 'graph.microsoft.com'; PathTemplate = '/v1.0/reports/authenticationMethods/userRegistrationDetails'; ApiStability = 'Stable'; Method = 'GET'; ReadOnlyClassification = $null; Description = 'Bulk authentication-method registration report (USR-012)' }
        [ordered]@{ Host = 'graph.microsoft.com'; PathTemplate = '/v1.0/roleManagement/directory/roleAssignments'; ApiStability = 'Stable'; Method = 'GET'; ReadOnlyClassification = $null; Description = 'Directory RBAC role assignments including administrative-unit scope (CAP-011)' }
        [ordered]@{ Host = 'graph.microsoft.com'; PathTemplate = '/v1.0/servicePrincipals/{spId}/appRoleAssignments'; ApiStability = 'Stable'; Method = 'GET'; ReadOnlyClassification = $null; Description = 'List application permissions (app role assignments) granted to a service principal (ENT-004/009, AGT-002/006, MAI-001)' }
        [ordered]@{ Host = 'graph.microsoft.com'; PathTemplate = '/v1.0/servicePrincipals/{spId}/oauth2PermissionGrants'; ApiStability = 'Stable'; Method = 'GET'; ReadOnlyClassification = $null; Description = 'List delegated permissions granted to a service principal as client (ENT-005/010, AGT-003/007)' }
