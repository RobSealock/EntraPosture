...
function Test-EntraPostureInternalAgentIdentityExtensiveApiApplicationPrivilegeControl {
    <#
        .SYNOPSIS
        AGT-006's evaluator: thin wrapper over Get-EntraPostureExtensiveApiPrivilegeControlResult
        for internal AgentIdentity entities' application (app role) permissions.
