@{
    ...
    SourceFiles = @(
        ...
        'src/Collectors/CollectGroupSettings.ps1'
        'src/Collectors/CollectUserSignInActivity.ps1'
        'src/Collectors/CollectServicePrincipalApiPermissions.ps1'
        'src/Collectors/CollectUserRegistrationDetails.ps1'
        'src/Collectors/CollectRoleAssignmentScopes.ps1'
